...
addStringToSF(String modelo) async {
  ...
  prefs.remove('gabinete');
  prefs.setString('gabinete', modelo);
}

final FirebaseFirestore db = FirebaseFirestore.instance;

class ListGabinete extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _ListGabinete();
}

class _ListGabinete extends State<ListGabinete> {
  ...
  Future<QuerySnapshot> getProcesadores() {
    return db.collection('gabinete').get();
  }
}
