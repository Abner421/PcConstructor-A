...
addStringToSF(String modelo) async {
  ...
  prefs.setString('graficas', modelo);
}

final FirebaseFirestore db = FirebaseFirestore.instance;

class ListGraficas extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _ListGraficas();
}
...
class _ListGraficas extends State<ListGraficas> {
  ...
  Future<QuerySnapshot> getProcesadores() {
    return db.collection('graficas').get();
  }
}
