...
addStringToSF(String modelo) async {
  ...
  prefs.setString('coolCPU', modelo);
}

final FirebaseFirestore db = FirebaseFirestore.instance;

class ListCoolerCPU extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _ListCoolerCPU();
}
...
class _ListCoolerCPU extends State<ListCoolerCPU> {
  ...
  Future<QuerySnapshot> getProcesadores() {
    return db.collection('cpuCooler').get();
  }
}
